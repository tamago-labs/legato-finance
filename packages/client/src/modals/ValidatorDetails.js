...
const ValidatorDetails = ({ visible, close, data, select, avgApy, isTestnet }) => {
    ...
    const currentStaked = data && (Number(`${(BigNumber(data.stakingPoolSuiBalance).dividedBy(BigNumber(1000000000)).toFixed(2))}`) / 1000000).toFixed(1)
    const currentStakedUs = data && currentStaked * data.suiPrice
        ...
        >
            {data && (
                <div className="text-gray-300 mt-4">
                    ...
                    <div className="grid grid-cols-5 gap-5 py-0 sm:py-4 h-[180px]">
