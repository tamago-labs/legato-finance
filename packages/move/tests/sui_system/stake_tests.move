...
module legato::stake_tests {
    ...
    fun test_split_join_staked_sui() {
        ...
        test_scenario::next_tx(scenario, STAKER_ADDR_1);
        {
            ...
            assert!(amount1 == 20 * MIST_PER_SUI || amount1 == 80 * MIST_PER_SUI, 102);
            assert!(amount2 == 20 * MIST_PER_SUI || amount2 == 80 * MIST_PER_SUI, 103);
            assert!(amount1 + amount2 == 100 * MIST_PER_SUI, 104);

            staking_pool::join_staked_sui(&mut part1, part2);
            assert!(staking_pool::staked_sui_amount(&part1) == 100 * MIST_PER_SUI, 105);
    ...
    fun test_add_remove_stake_flow() {
        ...
        test_scenario::next_tx(scenario, STAKER_ADDR_1);
        {
            ...
            sui_system::request_add_stake(system_state_mut_ref, coin::mint_for_testing(60 * MIST_PER_SUI, ctx), VALIDATOR_ADDR_1, ctx);
