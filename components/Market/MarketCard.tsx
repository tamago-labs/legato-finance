...
const MarketCard = () => {
    ...
    return (
        <Link href="/markets/coinmarketcap">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className={`  bg-black bg-gradient-to-b  from-white/[0.03]  to-transparent hidden  md:flex flex-row rounded  overflow-hidden  border  border-gray/30   h-[90px]  `} >
