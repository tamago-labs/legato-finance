...
const StakePanel = () => {
    ...
    const { activeTab, depositAmount, errorMessage, loading, tick } = values
                                ...
                                <div className="px-1 mt-4 sm:mt-6">
                                    <ListGroup
                                        items={[
                                            ...
                                            ["Projected rewards", `${estimateAmount.toLocaleString()} SUI per month`]
                                        ]}
                                    />
                                </div>
                        ...
                        {activeTab === Tab.Withdraw && (
                            <div className='py-3'>
                                ...
                                <div className="px-1 mt-4 sm:mt-6">
                                    <ListGroup
                                        items={[
                                            ["You will receive", `${estimateOutput2.toFixed(6)} SUI`],
